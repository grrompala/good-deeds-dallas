...
const SOURCES = {
  volunteergarland: {
    ...
    summary:     "The City of Garland's official volunteer portal, with concrete shifts and projects posted directly by Garland area nonprofits.",
  ...
  volunteermckinney: {
    ...
    summary:     "McKinney's local volunteer hub, pulling together specific opportunities from nonprofits across the McKinney area.",
  ...
  idealist: {
    ...
    domain:      'idealist.org',
    summary:     "A nationwide board for volunteer and nonprofit jobs. We pull in the Dallas area slice.",
    short:       ['Idealist'],
    bg:          'bg-sky-50',
    text:        'text-sky-700',
  ...
  curated: {
    ...
    url:         null,
    domain:      null,
    summary:     'Local DFW nonprofits we follow directly, including organizations whose opportunities never make it to the big volunteer portals.',
    short:       ['GDD', 'Curated'],
    bg:          'bg-amber-50',
    text:        'text-amber-700',
