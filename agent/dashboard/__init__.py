"""Interactive discovery dashboard (Streamlit) — a human-in-the-loop console for
the discovery agent. Build a query, step through each pipeline stage, inspect and
